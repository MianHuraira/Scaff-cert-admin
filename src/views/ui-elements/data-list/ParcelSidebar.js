...
// ** Reactstrap Imports
import { Button, Label, FormText, Form, Input, DropdownItem } from 'reactstrap'
...
const SidebarNewParcel = ({ open, toggleSidebar }) => {
  // ** States
  ...
  return (
    ...
    >
      ...
      <Form onSubmit={handleSubmit(onSubmit)}>
        ...
        <h5 className=' mt-2'>CUSTOMERS INFO</h5>
...
export default SidebarNewParcel
